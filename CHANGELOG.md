...
- Set max of `limit_commits` to the number of commits ([#140](https://github.com/orhun/git-cliff/issues/140))
- Update cargo-tarpaulin installation command for CI
- Use MUSL build of cargo-tarpaulin
- Remove target directory from .dockerignore
- Set the node cache dependency path
- Fix broken links
- Fix spellig mistake and add missing dependency
- Remove extra backtick in command example
- Fix MATURIN_REPOSITORY definition
...
- Add link to the Console #141 interview about git-cliff
- Remove unneeded word in README.md ([#141](https://github.com/orhun/git-cliff/issues/141))
...
- Add release-plz to related projects ([#151](https://github.com/orhun/git-cliff/issues/151))
- Add discord badge
- Add tj-actions/git-cliff to the list of actions ([#152](https://github.com/orhun/git-cliff/issues/152))
- Move documentation to the website ([#153](https://github.com/orhun/git-cliff/issues/153))
- Update README.md about documentation website
- Add Twitter link to banner
- Mention the nightly requirement for rustfmt
- Draft docs for install from PyPI
- Add example for pip install command
...
- Update clap and clap extras to v4 ([#137](https://github.com/orhun/git-cliff/issues/137))
- Make the fields of `Signature` public
- Support placing configuration inside pyproject.toml ([#147](https://github.com/orhun/git-cliff/issues/147))
- Support using regex group values ([#145](https://github.com/orhun/git-cliff/issues/145))
...
- Upgrade core dependencies
- Update versions in Dockerfile
- Bump build-push-action to v4
- Update runner images
- Bump the action versions in docker workflow
- Switch to dtolnay/rust-toolchain action
- Move website to docs for GitHub pages deployment
- Move website to website folder
- Add workflow file for deploying the website
- First shot at PyPi publishing
- Rc1 for pypi publish workflow
- Rc2 for pypi publish
- Rc3 for pypi publish workflow
...
- [**breaking**] Move changelog module to git-cliff-core
- Handle errors for changelog module tests
- Update header location
- Test the website deployment with a different job
...
- Apply formatting
- Update the style for project name
...
- Test the website deployment for pull requests
